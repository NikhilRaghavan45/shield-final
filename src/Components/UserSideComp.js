...
const UserSideComp = ({ isSidebarVisible, hideNav }) => {
  return (
              ...
              <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                ...
                <li className="nav-item dropdown position-relative">
                  ...
                  <ul className="dropdown-menu sidebar-dropdown position-absolute" aria-labelledby="productDetailsDropdown">
                    <li><Link to="/SareeUser" onClick={hideNav}>Saree</Link></li>
                    <li><Link to="/lehengauser" onClick={hideNav}>Lehenga</Link></li>
                    <li><Link to="/pantsuser" onClick={hideNav}>Jeans</Link></li>
                    <li><Link to="/topsuser" onClick={hideNav}>Tops</Link></li>
                  </ul>
